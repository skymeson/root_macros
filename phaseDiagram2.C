...
void phaseDiagram2(){
  ...
  if(iSave){
    cPhase->Update();
    cPhase->SaveAs("phaseDiagram.eps");
  }
}
...
void drawExperiments(){
  ...
  //TEllipse *eRHIC = new TEllipse(0.410685, 0.532627, 0.035, 0.13, 0., 165., 335.);
  ...
  //TArrow *aRHIC = new TArrow(0.391353, 0.578867, 0.390539, 0.577451, 0.025, "|>");
  aRHIC->Draw();
  TLatex *xRHIC = new TLatex(0.417432, 0.679342, "RHIC");
  //TLatex *xRHIC = new TLatex(0.470968, 0.656568, "AGS");
